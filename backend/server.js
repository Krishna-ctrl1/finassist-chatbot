...
async function handleTicketCreationFlow(message, chat, customerId) {
  ...
  if (
    lastBotMessage &&
    lastBotMessage.content.includes("Ticket Created Successfully!")
  ) {
...
Ticket creation process completed. Is there anything else I can help you with regarding your investments or account?`;
          ...
          console.log(
            `Success message added to chat ${chatId} for ticket ${savedTicket.ticket_id}`
          );
        } catch (chatError) {
          console.error(
            "Error updating chat with ticket success message:",
            chatError
          );
